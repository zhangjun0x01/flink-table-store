...
public abstract class ObjectsFile<T> {
    ...
    public List<T> readWithIOException(
        ...
        RecordReader<InternalRow> reader =
                createFormatReader(fileIO, readerFactory, pathFactory.toPath(fileName), null);
    ...
    private CloseableIterator<InternalRow> createIterator(String fileName) {
        try {
            return createFormatReader(fileIO, readerFactory, pathFactory.toPath(fileName), null)
                    .toCloseableIterator();
        } catch (IOException e) {

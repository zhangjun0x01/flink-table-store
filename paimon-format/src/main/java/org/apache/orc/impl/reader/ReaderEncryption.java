...
public class ReaderEncryption {
    ...
    /**
     * Get the variant for a given column that the user has access to. If we haven't tried a given
     * key, try to decrypt this variant's footer key to see if the KeyProvider will give it to us.
     * If not, continue to the next variant.
     *
